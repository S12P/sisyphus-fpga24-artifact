...
void kernel_syrk(float alpha,float beta,merlin_uint_256 C[7200],merlin_uint_256 A[6000])
{
  
#pragma HLS INTERFACE m_axi port=A offset=slave depth=6000 bundle=merlin_gmem_kernel_syrk_256_0
  
#pragma HLS INTERFACE m_axi port=C offset=slave depth=7200 bundle=merlin_gmem_kernel_syrk_256_C
...
{
      memcpy_wide_bus_read_float_3d_120_200_256(A_7_0_buf,0,0,0,(merlin_uint_256 *)A,(0 * 4),sizeof(float ) * ((unsigned long )48000L),48000L);
