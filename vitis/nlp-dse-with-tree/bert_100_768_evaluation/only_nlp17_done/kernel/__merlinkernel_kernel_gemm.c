...
void kernel_gemm(merlin_uint_64 C[38400],merlin_uint_128 A[2500],merlin_uint_64 B[38400])
{
...
/* Existing HLS partition: #pragma HLS array_partition variable=C_buf cyclic factor = 2 dim=3 */
  memcpy_wide_bus_read_float_3d_128_6_64(C_buf,0,0,0,(merlin_uint_64 *)C,(0 * 4),sizeof(float ) * ((unsigned long )76800L),76800L);
{
    memcpy_wide_bus_read_float_2d_100_128(A_5_0_buf,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )10000L),10000L);
  }
{
    memcpy_wide_bus_read_float_3d_128_6_64(B_5_0_buf,0,0,0,(merlin_uint_64 *)B,(0 * 4),sizeof(float ) * ((unsigned long )76800L),76800L);
  }
  merlinL3:
  for (i = 0; i < 100; i++) {
    merlinL2:
...
/* Existing HLS partition: #pragma HLS array_partition variable=C_buf cyclic factor = 2 dim=3 */
  memcpy_wide_bus_write_float_3d_128_6_64((merlin_uint_64 *)C,C_buf,0,0,0,(4 * 0),sizeof(float ) * ((unsigned long )76800L),76800L);
}
