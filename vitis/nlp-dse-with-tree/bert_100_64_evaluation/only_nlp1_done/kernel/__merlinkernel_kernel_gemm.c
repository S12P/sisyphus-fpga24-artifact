...
#pragma HLS array_partition variable=A_5_0_buf cyclic factor=4 dim=3
  ...
  int k;
{
    memcpy_wide_bus_read_float_3d_20_100_128(A_5_0_buf,0,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )10000L),10000L);
  }
{
...
{
      memcpy_wide_bus_read_float_2d_64_512(C_buf,(size_t )0,(size_t )0,(merlin_uint_512 *)C,(size_t )(((long )i) * 1280L * ((long )4)),sizeof(float ) * ((unsigned long )1280L),(size_t )1280L);
    }
    merlinL2:
...
{
      memcpy_wide_bus_write_float_2d_64_512((merlin_uint_512 *)C,C_buf,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 1280L)),sizeof(float ) * ((unsigned long )1280L),(size_t )1280L);
    }
  }
