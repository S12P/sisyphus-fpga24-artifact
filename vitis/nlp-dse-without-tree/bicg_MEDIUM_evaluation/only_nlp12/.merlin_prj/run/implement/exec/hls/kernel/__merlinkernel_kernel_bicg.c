...
#pragma HLS array_partition variable=p_4_0_buf cyclic factor=16 dim=1
    float A_4_1_buf[410][390];
    
#pragma HLS array_partition variable=A_4_1_buf cyclic factor=2 dim=2
...
#pragma HLS array_partition variable=s_buf cyclic factor=16 dim=1
