...
void kernel_bicg(merlin_uint_64 A[79950],merlin_uint_512 s[25],merlin_uint_64 q[205],merlin_uint_512 p[25],merlin_uint_64 r[205])
{
...
#pragma HLS INTERFACE m_axi port=q offset=slave depth=205 bundle=merlin_gmem_kernel_bicg_64_q
  
#pragma HLS INTERFACE m_axi port=r offset=slave depth=205 bundle=merlin_gmem_kernel_bicg_64_1
...
/* Existing HLS partition: #pragma HLS array_partition variable=q_buf cyclic factor = 2 dim=2 */
    memcpy_wide_bus_read_float_2d_10_64(q_buf,0,0,(merlin_uint_64 *)q,(0 * 4),sizeof(float ) * ((unsigned long )410),410L);
{
      memcpy_wide_bus_read_float_2d_10_64(r_5_0_buf,0,0,(merlin_uint_64 *)r,(0 * 4),sizeof(float ) * ((unsigned long )410),410L);
    }
{
      memcpy_wide_bus_read_float_3d_10_390_64(A_5_0_buf,0,0,0,(merlin_uint_64 *)A,(0 * 4),sizeof(float ) * ((unsigned long )159900L),159900L);
/* Existing HLS partition: #pragma HLS array_partition variable=A_5_1_buf cyclic factor = 2 dim=3 */
      memcpy_wide_bus_read_float_3d_10_390_64(A_5_1_buf,0,0,0,(merlin_uint_64 *)A,(0 * 4),sizeof(float ) * ((unsigned long )159900L),159900L);
    }
{
...
/* Existing HLS partition: #pragma HLS array_partition variable=q_buf cyclic factor = 2 dim=2 */
    memcpy_wide_bus_write_float_2d_10_64((merlin_uint_64 *)q,q_buf,0,0,(4 * 0),sizeof(float ) * ((unsigned long )410),410L);
/* Existing HLS partition: #pragma HLS array_partition variable=s_buf cyclic factor = 16 dim=1 */
...
/* Existing HLS partition: #pragma HLS array_partition variable=r_5_0_buf cyclic factor = 2 dim=2 */
}
