...
static void merlin_memcpy_1(float dst[390],int dst_idx_0,float src[26][15],int src_idx_0,int src_idx_1,unsigned int len,unsigned int max_len)
{
...
{
      memcpy_wide_bus_read_float_3d_15_410_64(A_5_0_buf,0,0,0,(merlin_uint_64 *)A,(0 * 4),sizeof(float ) * ((unsigned long )159900L),159900L);
    }
{
