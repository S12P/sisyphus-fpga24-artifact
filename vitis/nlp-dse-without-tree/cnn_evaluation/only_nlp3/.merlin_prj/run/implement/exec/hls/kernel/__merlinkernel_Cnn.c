...
void mars_kernel_0_1_node_0_stage_0(int i,int exec,merlin_uint_512 merlin_output[802816],float merlin_output_buf_0[4][28][8][224])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_read_float_4d_28_8_224_512(merlin_output_buf_0,(size_t )0,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_512 *)merlin_output,(size_t )(((long )i) * 200704L * ((long )4)),sizeof(float ) * ((unsigned long )200704L),(size_t )200704L);
  }
}

static void merlin_memcpy_0(float dst[4][256][5][5],int dst_idx_0,int dst_idx_1,int dst_idx_2,int dst_idx_3,float src[1638400],long src_idx_0,unsigned int len,unsigned int max_len)
{
...
#pragma HLS function_instantiate variable=dst_idx_0,dst_idx_1,dst_idx_2,dst_idx_3,src_idx_0
  unsigned long i;
  unsigned long total_offset1 = (((0 * 4 + dst_idx_0) * 256 + dst_idx_1) * 5 + dst_idx_2) * 5 + dst_idx_3;
...
#pragma HLS LOOP_TRIPCOUNT max=25600
    dst[(total_offset1 + i) / 5 / 5 / 256][(total_offset1 + i) / 5 / 5 % 256][(total_offset1 + i) / 5 % 5][(total_offset1 + i) % 5] = src[total_offset2 + i];
  }
}

void mars_kernel_0_1_node_1_stage_0(int i,int exec,float weight[1638400],float weight_9_0_buf_0[4][256][5][5])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    merlin_memcpy_0(weight_9_0_buf_0,0,0,0,0,weight,((long )i) * 25600L,sizeof(float ) * ((unsigned long )25600L),102400UL);
  }
}

void mars_kernel_0_1_node_2_stage_1(int i,int exec,merlin_uint_128 merlin_input[3326976],float merlin_output_buf_0[4][28][8][224],float weight_9_0_buf_0[4][256][5][5])
{
...
#pragma HLS unroll
                  merlin_output_buf_0[i_sub][h][h_sub][w] += weight_9_0_buf_0[i_sub][j][p][q] * merlin_input_9_0_buf[((long )h) * 8L + ((long )h_sub) + ((long )p)][q + w];
                }
              }
            }
          }
...
void mars_kernel_0_1_node_3_stage_2(int i,int exec,merlin_uint_512 merlin_output[802816],float merlin_output_buf_0[4][28][8][224])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_write_float_4d_28_8_224_512((merlin_uint_512 *)merlin_output,merlin_output_buf_0,(size_t )0,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 200704L)),sizeof(float ) * ((unsigned long )200704L),(size_t )200704L);
  }
}

void mars_kernel_0_1_bus(int mars_i,int mars_init,int mars_cond,merlin_uint_128 merlin_input[3326976],merlin_uint_512 merlin_output[802816],float mars_merlin_output_buf_0_0[4][28][8][224],float mars_merlin_output_buf_0_1[4][28][8][224],float mars_merlin_output_buf_0_2[4][28][8][224],float weight[1638400],float mars_weight_9_0_buf_0_0[4][256][5][5],float mars_weight_9_0_buf_0_1[4][256][5][5])
{
...
#pragma ACCEL interface variable=merlin_input depth=256,228,228 max_depth=256,228,228
  float weight_9_0_buf_0[4][256][5][5];
  float merlin_output_buf_0[4][28][8][224];
  int mars_count_0_1 = 0;
  float mars_kernel_0_1_merlin_output_buf_0_0[4][28][8][224];
...
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 cyclic factor=16 dim=4
  float mars_kernel_0_1_merlin_output_buf_0_1[4][28][8][224];
...
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 cyclic factor=16 dim=4
  float mars_kernel_0_1_merlin_output_buf_0_2[4][28][8][224];
...
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 cyclic factor=16 dim=4
  float mars_kernel_0_1_weight_9_0_buf_0_0[4][256][5][5];
...
#pragma HLS array_partition variable=mars_kernel_0_1_weight_9_0_buf_0_0 complete dim=3
  float mars_kernel_0_1_weight_9_0_buf_0_1[4][256][5][5];
...
#pragma HLS array_partition variable=mars_kernel_0_1_weight_9_0_buf_0_1 complete dim=3
  float mars_kernel_0_1_weight_9_0_buf_0_2[4][256][5][5];
...
{
    if (mars_count_0_1 == 0) 
      mars_kernel_0_1(i,0,63,merlin_input,merlin_output,mars_kernel_0_1_merlin_output_buf_0_0,mars_kernel_0_1_merlin_output_buf_0_1,mars_kernel_0_1_merlin_output_buf_0_2,weight,mars_kernel_0_1_weight_9_0_buf_0_0,mars_kernel_0_1_weight_9_0_buf_0_1);
     else if (mars_count_0_1 == 1) 
      mars_kernel_0_1(i,0,63,merlin_input,merlin_output,mars_kernel_0_1_merlin_output_buf_0_2,mars_kernel_0_1_merlin_output_buf_0_0,mars_kernel_0_1_merlin_output_buf_0_1,weight,mars_kernel_0_1_weight_9_0_buf_0_2,mars_kernel_0_1_weight_9_0_buf_0_0);
     else 
      mars_kernel_0_1(i,0,63,merlin_input,merlin_output,mars_kernel_0_1_merlin_output_buf_0_1,mars_kernel_0_1_merlin_output_buf_0_2,mars_kernel_0_1_merlin_output_buf_0_0,weight,mars_kernel_0_1_weight_9_0_buf_0_1,mars_kernel_0_1_weight_9_0_buf_0_2);
    mars_count_0_1++;
    if (mars_count_0_1 == 3) 
      mars_count_0_1 = 0;
  }
