...
void mars_kernel_0_1_node_0_stage_0(int i,int exec,merlin_uint_512 merlin_output[802816],float merlin_output_buf_0[224][28][8])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_read_float_3d_28_8_512(merlin_output_buf_0,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_512 *)merlin_output,(size_t )(((long )i) * 50176L * ((long )4)),sizeof(float ) * ((unsigned long )50176L),(size_t )50176L);
  }
}

void mars_kernel_0_1_node_1_stage_1(int i,int exec,merlin_uint_128 merlin_input[3326976],float merlin_output_buf_0[224][28][8],float weight_8_0_buf[256][256][5][5])
{
...
#pragma HLS array_partition variable=merlin_input_8_0_buf cyclic factor=12 dim=2
...
#pragma HLS unroll
                merlin_output_buf_0[h][w][w_sub] += weight_8_0_buf[i][j][p][q] * merlin_input_8_0_buf[h + p][((long )w) * 8L + ((long )q) + ((long )w_sub)];
              }
            }
          }
        }
...
void mars_kernel_0_1_node_2_stage_2(int i,int exec,merlin_uint_512 merlin_output[802816],float merlin_output_buf_0[224][28][8])
{
  
#pragma HLS INLINE OFF
  if (exec == 1) {
    memcpy_wide_bus_write_float_3d_28_8_512((merlin_uint_512 *)merlin_output,merlin_output_buf_0,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 50176L)),sizeof(float ) * ((unsigned long )50176L),(size_t )50176L);
  }
}

void mars_kernel_0_1_bus(int mars_i,int mars_init,int mars_cond,merlin_uint_128 merlin_input[3326976],merlin_uint_512 merlin_output[802816],float mars_merlin_output_buf_0_0[224][28][8],float mars_merlin_output_buf_0_1[224][28][8],float mars_merlin_output_buf_0_2[224][28][8],float mars_weight_8_0_buf_1[256][256][5][5])
{
...
void mars_kernel_0_1(int mars_i,int mars_init,int mars_cond,merlin_uint_128 merlin_input[3326976],merlin_uint_512 merlin_output[802816],float mars_merlin_output_buf_0_0[224][28][8],float mars_merlin_output_buf_0_1[224][28][8],float mars_merlin_output_buf_0_2[224][28][8],float mars_weight_8_0_buf_1[256][256][5][5])
{
...
#pragma HLS array_partition variable=weight_8_0_buf complete dim=3
{
  ...
  float merlin_output_buf_0[224][28][8];
  int mars_count_0_1 = 0;
  float mars_kernel_0_1_merlin_output_buf_0_0[224][28][8];
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 cyclic factor=2 dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 cyclic factor=2 dim=2 */
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 complete dim=3
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_0 cyclic factor=2 dim=2
  float mars_kernel_0_1_merlin_output_buf_0_1[224][28][8];
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 cyclic factor=2 dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 cyclic factor=2 dim=2 */
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 complete dim=3
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_1 cyclic factor=2 dim=2
  float mars_kernel_0_1_merlin_output_buf_0_2[224][28][8];
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 cyclic factor=2 dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 cyclic factor=2 dim=2 */
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 complete dim=3
  
#pragma HLS array_partition variable=mars_kernel_0_1_merlin_output_buf_0_2 cyclic factor=2 dim=2
  merlinL7:
