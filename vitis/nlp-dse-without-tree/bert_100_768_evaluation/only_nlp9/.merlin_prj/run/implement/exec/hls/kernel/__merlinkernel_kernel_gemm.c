...
void kernel_gemm(merlin_uint_128 C[19200],merlin_uint_64 A[5000],merlin_uint_128 B[19200])
{
  
#pragma HLS INTERFACE m_axi port=A offset=slave depth=5000 bundle=merlin_gmem_kernel_gemm_64_0
  
#pragma HLS INTERFACE m_axi port=B offset=slave depth=19200 bundle=merlin_gmem_kernel_gemm_128_0
  
#pragma HLS INTERFACE m_axi port=C offset=slave depth=19200 bundle=merlin_gmem_kernel_gemm_128_C
...
{
    memcpy_wide_bus_read_float_4d_10_64_12_128(B_7_0_buf,0,0,0,0,(merlin_uint_128 *)B,(0 * 4),sizeof(float ) * ((unsigned long )76800L),76800L);
  }
  merlinL5:
  for (i = 0; i < 10; i++) 
...
/* Original: #pragma ACCEL PARALLEL FACTOR=10 */
{
    float C_buf[10][64][12];
    
#pragma HLS array_partition variable=C_buf cyclic factor=4 dim=3
{
      memcpy_wide_bus_read_float_3d_64_12_128(C_buf,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_128 *)C,(size_t )(((long )i) * 7680L * ((long )4)),sizeof(float ) * ((unsigned long )7680L),(size_t )7680L);
    }
    merlinL4:
...
{
      memcpy_wide_bus_write_float_3d_64_12_128((merlin_uint_128 *)C,C_buf,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 7680L)),sizeof(float ) * ((unsigned long )7680L),(size_t )7680L);
    }
  }
