...
#pragma HLS array_partition variable=A_7_0_buf cyclic factor=2 dim=3
  ...
  int k;
{
    memcpy_wide_bus_read_float_4d_2_50_2_128(A_7_0_buf,0,0,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )10000L),10000L);
  }
{
    memcpy_wide_bus_read_float_4d_2_192_4_512(B_7_0_buf,0,0,0,0,(merlin_uint_512 *)B,(0 * 4),sizeof(float ) * ((unsigned long )76800L),76800L);
  }
  merlinL5:
  for (i = 0; i < 50; i++) 
...
{
      memcpy_wide_bus_read_float_3d_192_4_512(C_buf,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_512 *)C,(size_t )(((long )i) * 1536L * ((long )4)),sizeof(float ) * ((unsigned long )1536L),(size_t )1536L);
    }
    merlinL4:
...
{
      memcpy_wide_bus_write_float_3d_192_4_512((merlin_uint_512 *)C,C_buf,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 1536L)),sizeof(float ) * ((unsigned long )1536L),(size_t )1536L);
    }
  }
...
/* Existing HLS partition: #pragma HLS array_partition variable=B_7_0_buf cyclic factor = 4 dim=3 */
