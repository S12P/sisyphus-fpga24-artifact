...
#pragma HLS array_partition variable=A_6_0_buf cyclic factor=4 dim=3
  ...
  int k;
{
    memcpy_wide_bus_read_float_3d_10_100_128(A_6_0_buf,0,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )10000L),10000L);
  }
{
...
/* Original: #pragma ACCEL PARALLEL FACTOR=10 */
{
    float C_buf[10][12][64];
    
#pragma HLS array_partition variable=C_buf cyclic factor=16 dim=3
{
      memcpy_wide_bus_read_float_3d_12_64_512(C_buf,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_512 *)C,(size_t )(((long )i) * 7680L * ((long )4)),sizeof(float ) * ((unsigned long )7680L),(size_t )7680L);
    }
    merlinL3:
...
{
      memcpy_wide_bus_write_float_3d_12_64_512((merlin_uint_512 *)C,C_buf,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 7680L)),sizeof(float ) * ((unsigned long )7680L),(size_t )7680L);
    }
  }
