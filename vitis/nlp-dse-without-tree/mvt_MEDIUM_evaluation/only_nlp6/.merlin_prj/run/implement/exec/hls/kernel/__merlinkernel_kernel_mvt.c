...
{
      memcpy_wide_bus_read_float_4d_16_25_16_512(A_8_0_buf,0,0,0,0,(merlin_uint_512 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
...
{
      memcpy_wide_bus_read_float_4d_16_25_16_512(A_9_0_buf,0,0,0,0,(merlin_uint_512 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
