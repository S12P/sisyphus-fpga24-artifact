...
void kernel_mvt(merlin_uint_512 x1[25],merlin_uint_512 x2[25],merlin_uint_128 y_1[100],merlin_uint_512 y_2[25],merlin_uint_128 A[40000])
{
  
#pragma HLS INTERFACE m_axi port=A offset=slave depth=40000 bundle=merlin_gmem_kernel_mvt_128_0
...
#pragma HLS INTERFACE m_axi port=y_1 offset=slave depth=100 bundle=merlin_gmem_kernel_mvt_128_1
...
#pragma HLS array_partition variable=y_2_7_0_buf cyclic factor=16 dim=1
    float A_7_0_buf[400][4][100];
    
#pragma HLS array_partition variable=A_7_0_buf cyclic factor=4 dim=3
    float x1_buf[400];
...
{
      memcpy_wide_bus_read_float_3d_4_100_128(A_6_0_buf,0,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
      memcpy_wide_bus_read_float_2d_100_128(y_1_6_0_buf,0,0,(merlin_uint_128 *)y_1,(0 * 4),sizeof(float ) * ((unsigned long )400),400L);
    }
    merlinL5:
    for (i = 0; i < 400; i++) {
      merlinL4:
...
{
      memcpy_wide_bus_read_float_3d_4_100_128(A_7_0_buf,0,0,0,(merlin_uint_128 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
...
{
        memcpy_wide_bus_read_float_2d_1_512(x2_buf,(size_t )0,(size_t )0,(merlin_uint_512 *)x2,(size_t )(i * 100 * 4),sizeof(float ) * ((unsigned long )100),(size_t )100L);
      }
      merlinL1:
...
{
        memcpy_wide_bus_write_float_2d_1_512((merlin_uint_512 *)x2,x2_buf,(size_t )0,(size_t )0,(size_t )(4 * (i * 100)),sizeof(float ) * ((unsigned long )100),(size_t )100L);
      }
    }
...
/* Existing HLS partition: #pragma HLS array_partition variable=A_7_0_buf cyclic factor = 4 dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=y_1_6_0_buf cyclic factor = 4 dim=2 */
