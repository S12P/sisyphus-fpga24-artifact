...
#pragma ACCEL interface variable=x1 depth=400 max_depth=400
  ...
  int j;
{
    float y_1_8_0_buf[50][8];
    
#pragma HLS array_partition variable=y_1_8_0_buf complete dim=2
    
#pragma HLS array_partition variable=y_1_8_0_buf cyclic factor=2 dim=1
    float A_8_0_buf[25][16][50][8];
    
#pragma HLS array_partition variable=A_8_0_buf complete dim=4
    
#pragma HLS array_partition variable=A_8_0_buf cyclic factor=2 dim=3
...
#pragma HLS array_partition variable=y_2_9_0_buf complete dim=2
    float A_9_0_buf[25][16][50][8];
    
#pragma HLS array_partition variable=A_9_0_buf complete dim=4
    
#pragma HLS array_partition variable=A_9_0_buf cyclic factor=2 dim=3
...
#pragma HLS array_partition variable=x2_buf cyclic factor=2 dim=1
    float x1_buf[25][16];
...
{
      memcpy_wide_bus_read_float_4d_16_50_8_512(A_8_0_buf,0,0,0,0,(merlin_uint_512 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
      memcpy_wide_bus_read_float_2d_8_512(y_1_8_0_buf,0,0,(merlin_uint_512 *)y_1,(0 * 4),sizeof(float ) * ((unsigned long )400),400L);
    }
    merlinL7:
    for (i = 0; i < 25; i++) 
...
/* Existing HLS partition: #pragma HLS array_partition variable=x2_buf cyclic factor = 2 dim=1 */
    memcpy_wide_bus_read_float_2d_8_512(x2_buf,0,0,(merlin_uint_512 *)x2,(0 * 4),sizeof(float ) * ((unsigned long )400),400L);
{
      memcpy_wide_bus_read_float_4d_16_50_8_512(A_9_0_buf,0,0,0,0,(merlin_uint_512 *)A,(0 * 4),sizeof(float ) * ((unsigned long )160000L),160000L);
    }
{
...
/* Existing HLS partition: #pragma HLS array_partition variable=x2_buf complete dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=x2_buf cyclic factor = 2 dim=1 */
    memcpy_wide_bus_write_float_2d_8_512((merlin_uint_512 *)x2,x2_buf,0,0,(4 * 0),sizeof(float ) * ((unsigned long )400),400L);
  }
...
/* Existing HLS partition: #pragma HLS array_partition variable=A_9_0_buf cyclic factor = 2 dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=y_1_8_0_buf complete dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=y_1_8_0_buf cyclic factor = 2 dim=1 */
