...
#pragma HLS array_partition variable=y_1_4_0_buf cyclic factor=16 dim=1
    float A_4_0_buf[400][400];
    
#pragma HLS array_partition variable=A_4_0_buf cyclic factor=16 dim=2
...
#pragma HLS pipeline
        x2_buf[i] = x2_buf[i] + A_5_0_buf[j][i] * y_2_5_0_buf[j];
      }
    }
/* Existing HLS partition: #pragma HLS array_partition variable=x2_buf cyclic factor = 16 dim=1 */
