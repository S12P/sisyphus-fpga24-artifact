...
{
    float B_4_0_buf[200][60][4];
    
#pragma HLS array_partition variable=B_4_0_buf complete dim=3
    
#pragma HLS array_partition variable=B_4_0_buf cyclic factor=4 dim=2
...
#pragma HLS array_partition variable=A_5_0_buf complete dim=2
    float B_5_1_buf[200][60][4];
    
#pragma HLS array_partition variable=B_5_1_buf complete dim=3
    
#pragma HLS array_partition variable=B_5_1_buf cyclic factor=4 dim=2
    float B_5_0_buf[199][60][4];
...
#pragma HLS array_partition variable=C_buf complete dim=1
    memcpy_wide_bus_read_float_3d_60_4_512(C_buf,0,0,0,(merlin_uint_512 *)C,(0 * 4),sizeof(float ) * ((unsigned long )48000L),48000L);
{
      memcpy_wide_bus_read_float_3d_60_4_512(B_5_0_buf,0,0,0,(merlin_uint_512 *)B,(0 * 4),sizeof(float ) * ((unsigned long )47760L),47760L);
/* Existing HLS partition: #pragma HLS array_partition variable=B_5_1_buf complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=B_5_1_buf cyclic factor = 4 dim=2 */
      memcpy_wide_bus_read_float_3d_60_4_512(B_5_1_buf,0,0,0,(merlin_uint_512 *)B,(0 * 4),sizeof(float ) * ((unsigned long )48000L),48000L);
/* Existing HLS partition: #pragma HLS array_partition variable=B_4_0_buf complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=B_4_0_buf cyclic factor = 4 dim=2 */
      memcpy_wide_bus_read_float_3d_60_4_512(B_4_0_buf,0,0,0,(merlin_uint_512 *)B,(0 * 4),sizeof(float ) * ((unsigned long )48000L),48000L);
    }
{
...
/* Existing HLS partition: #pragma HLS array_partition variable=C_buf complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=C_buf cyclic factor = 4 dim=2 */
    memcpy_wide_bus_write_float_3d_60_4_512((merlin_uint_512 *)C,C_buf,0,0,0,(4 * 0),sizeof(float ) * ((unsigned long )48000L),48000L);
  }
