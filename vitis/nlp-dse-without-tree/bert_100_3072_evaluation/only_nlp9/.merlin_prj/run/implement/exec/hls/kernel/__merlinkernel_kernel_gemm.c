...
void kernel_gemm(merlin_uint_64 C[153600],float A[10000],merlin_uint_64 B[153600])
{
...
{
    memcpy_wide_bus_read_float_4d_5_512_6_64(B_7_0_buf,0,0,0,0,(merlin_uint_64 *)B,(0 * 4),sizeof(float ) * ((unsigned long )307200L),307200L);
  }
  merlinL6:
  for (i = 0; i < 10; i++) 
...
/* Original: #pragma ACCEL PARALLEL FACTOR=10 */
{
    float C_buf[10][512][6];
    
#pragma HLS array_partition variable=C_buf cyclic factor=2 dim=3
{
      memcpy_wide_bus_read_float_3d_512_6_64(C_buf,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_64 *)C,(size_t )(((long )i) * 30720L * ((long )4)),sizeof(float ) * ((unsigned long )30720L),(size_t )30720L);
    }
    merlinL5:
...
{
      memcpy_wide_bus_write_float_3d_512_6_64((merlin_uint_64 *)C,C_buf,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 30720L)),sizeof(float ) * ((unsigned long )30720L),(size_t )30720L);
    }
  }
