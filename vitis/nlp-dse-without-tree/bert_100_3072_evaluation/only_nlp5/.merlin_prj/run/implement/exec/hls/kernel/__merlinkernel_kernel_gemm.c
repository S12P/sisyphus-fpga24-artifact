...
void kernel_gemm(merlin_uint_512 C[19200],float A[10000],merlin_uint_512 B[19200])
{
...
{
    memcpy_wide_bus_read_float_4d_5_64_48_512(B_7_0_buf,0,0,0,0,(merlin_uint_512 *)B,(0 * 4),sizeof(float ) * ((unsigned long )307200L),307200L);
  }
  merlinL6:
  for (i = 0; i < 20; i++) 
...
{
      memcpy_wide_bus_read_float_3d_64_48_512(C_buf,(size_t )0,(size_t )0,(size_t )0,(merlin_uint_512 *)C,(size_t )(((long )i) * 15360L * ((long )4)),sizeof(float ) * ((unsigned long )15360L),(size_t )15360L);
    }
    merlinL5:
...
{
      memcpy_wide_bus_write_float_3d_64_48_512((merlin_uint_512 *)C,C_buf,(size_t )0,(size_t )0,(size_t )0,(size_t )(((long )4) * (((long )i) * 15360L)),sizeof(float ) * ((unsigned long )15360L),(size_t )15360L);
    }
  }
