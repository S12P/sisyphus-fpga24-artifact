...
void kernel_syrk(float alpha,float beta,merlin_uint_128 C[14400],merlin_uint_256 A[6000])
{
  
#pragma HLS INTERFACE m_axi port=A offset=slave depth=6000 bundle=merlin_gmem_kernel_syrk_256_0
  
#pragma HLS INTERFACE m_axi port=C offset=slave depth=14400 bundle=merlin_gmem_kernel_syrk_128_C
