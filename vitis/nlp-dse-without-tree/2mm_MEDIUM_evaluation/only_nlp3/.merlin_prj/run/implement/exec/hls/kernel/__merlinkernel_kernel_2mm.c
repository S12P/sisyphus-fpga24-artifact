...
#pragma HLS array_partition variable=A_8_0_buf complete dim=3
    float C_10_0_buf[190][110][2];
    
#pragma HLS array_partition variable=C_10_0_buf complete dim=3
    
#pragma HLS array_partition variable=C_10_0_buf cyclic factor=2 dim=2
    
#pragma HLS array_partition variable=C_10_0_buf complete dim=1
    float tmp_10_0_buf[60][3][190];
    
#pragma HLS array_partition variable=tmp_10_0_buf complete dim=3
    
#pragma HLS array_partition variable=tmp_10_0_buf complete dim=2
    float D_buf[60][3][110][2];
    
#pragma HLS array_partition variable=D_buf complete dim=4
    
#pragma HLS array_partition variable=D_buf cyclic factor=2 dim=3
    
#pragma HLS array_partition variable=D_buf complete dim=2
{
...
/* Existing HLS partition: #pragma HLS array_partition variable=D_buf complete dim=4 */
/* Existing HLS partition: #pragma HLS array_partition variable=D_buf cyclic factor = 2 dim=3 */
    memcpy_wide_bus_read_float_4d_3_110_2_128(D_buf,0,0,0,0,(merlin_uint_128 *)D,(0 * 4),sizeof(float ) * ((unsigned long )39600L),39600L);
{
      memcpy_wide_bus_read_float_3d_3_190_64(tmp_10_0_buf,0,0,0,(merlin_uint_64 *)tmp,(0 * 4),sizeof(float ) * ((unsigned long )34200L),34200L);
    }
{
      memcpy_wide_bus_read_float_3d_110_2_128(C_10_0_buf,0,0,0,(merlin_uint_128 *)C,(0 * 4),sizeof(float ) * ((unsigned long )41800L),41800L);
    }
    merlinL4:
    for (i = 0; i < 60; i++) 
/* Original: #pragma ACCEL PARALLEL FACTOR=3 */
...
#pragma HLS unroll
              D_buf[i][i_sub][j][j_sub] += tmp_10_0_buf[i][i_sub][k] * C_10_0_buf[k][j][j_sub];
            }
          }
        }
      }
...
/* Existing HLS partition: #pragma HLS array_partition variable=D_buf complete dim=4 */
/* Existing HLS partition: #pragma HLS array_partition variable=D_buf cyclic factor = 2 dim=3 */
    memcpy_wide_bus_write_float_4d_3_110_2_128((merlin_uint_128 *)D,D_buf,0,0,0,0,(4 * 0),sizeof(float ) * ((unsigned long )39600L),39600L);
  }
...
/* Existing HLS partition: #pragma HLS array_partition variable=C_10_0_buf complete dim=3 */
/* Existing HLS partition: #pragma HLS array_partition variable=C_10_0_buf cyclic factor = 2 dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=tmp_10_0_buf cyclic factor = 2 dim=3 */
}
