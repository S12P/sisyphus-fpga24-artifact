...
#pragma HLS array_partition variable=tmp_buf cyclic factor=8 dim=1
    memcpy_wide_bus_read_float_2d_2_512(tmp_buf,0,0,(merlin_uint_512 *)tmp,(0 * 4),sizeof(float ) * ((unsigned long )250),250L);
...
/* Existing HLS partition: #pragma HLS array_partition variable=y_buf cyclic factor = 8 dim=1 */
    memcpy_wide_bus_read_float_2d_2_512(y_buf,0,0,(merlin_uint_512 *)y,(0 * 4),sizeof(float ) * ((unsigned long )250),250L);
{
      memcpy_wide_bus_read_float_3d_2_250_64(A_4_0_buf,0,0,0,(merlin_uint_64 *)A,(0 * 4),sizeof(float ) * ((unsigned long )62500L),62500L);
    }
{
...
{
      memcpy_wide_bus_read_float_3d_2_250_64(B_4_0_buf,0,0,0,(merlin_uint_64 *)B,(0 * 4),sizeof(float ) * ((unsigned long )62500L),62500L);
    }
    merlinL2:
    for (i = 0; i < 125; i++) 
...
/* Existing HLS partition: #pragma HLS array_partition variable=y_buf complete dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=y_buf cyclic factor = 8 dim=1 */
    memcpy_wide_bus_write_float_2d_2_512((merlin_uint_512 *)y,y_buf,0,0,(4 * 0),sizeof(float ) * ((unsigned long )250),250L);
/* Existing HLS partition: #pragma HLS array_partition variable=tmp_buf complete dim=2 */
/* Existing HLS partition: #pragma HLS array_partition variable=tmp_buf cyclic factor = 8 dim=1 */
    memcpy_wide_bus_write_float_2d_2_512((merlin_uint_512 *)tmp,tmp_buf,0,0,(4 * 0),sizeof(float ) * ((unsigned long )250),250L);
  }
