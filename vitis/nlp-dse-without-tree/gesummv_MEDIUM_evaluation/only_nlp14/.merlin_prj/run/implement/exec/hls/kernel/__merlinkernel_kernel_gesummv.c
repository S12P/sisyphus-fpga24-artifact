...
#pragma HLS array_partition variable=B_3_0_buf cyclic factor=2 dim=2
    float x_3_1_buf[250];
    
#pragma HLS array_partition variable=x_3_1_buf cyclic factor=16 dim=1
    float x_3_0_buf[250];
    
#pragma HLS array_partition variable=x_3_0_buf cyclic factor=16 dim=1
    float A_3_0_buf[250][250];
    
#pragma HLS array_partition variable=A_3_0_buf cyclic factor=2 dim=2
    float y_buf[250];
