...
static void merlin_memcpy_0(float dst[250][50][5],int dst_idx_0,int dst_idx_1,int dst_idx_2,float src[62500],int src_idx_0,unsigned int len,unsigned int max_len)
{
...
#pragma HLS function_instantiate variable=dst_idx_0,dst_idx_1,dst_idx_2,src_idx_0
  unsigned long i;
  unsigned long total_offset1 = ((0 * 250 + dst_idx_0) * 50 + dst_idx_1) * 5 + dst_idx_2;
...
#pragma HLS LOOP_TRIPCOUNT max=62500
    dst[(total_offset1 + i) / 5 / 50][(total_offset1 + i) / 5 % 50][(total_offset1 + i) % 5] = src[total_offset2 + i];
  }
}
...
static void merlin_memcpy_2(float dst[50][5],int dst_idx_0,int dst_idx_1,float src[250],int src_idx_0,unsigned int len,unsigned int max_len)
{
...
static void merlin_memcpy_3(float dst[250][50][5],int dst_idx_0,int dst_idx_1,int dst_idx_2,float src[62500],int src_idx_0,unsigned int len,unsigned int max_len)
{
