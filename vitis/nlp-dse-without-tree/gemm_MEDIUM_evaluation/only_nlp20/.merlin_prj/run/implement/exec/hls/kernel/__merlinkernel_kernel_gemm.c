...
static void merlin_memcpy_0(float dst[200][44][5],int dst_idx_0,int dst_idx_1,int dst_idx_2,float src[44000],int src_idx_0,unsigned int len,unsigned int max_len)
{
...
#pragma HLS function_instantiate variable=dst_idx_0,dst_idx_1,dst_idx_2,src_idx_0
  unsigned long i;
  unsigned long total_offset1 = ((0 * 200 + dst_idx_0) * 44 + dst_idx_1) * 5 + dst_idx_2;
...
static void merlin_memcpy_2(float dst[44000],int dst_idx_0,float src[200][44][5],int src_idx_0,int src_idx_1,int src_idx_2,unsigned int len,unsigned int max_len)
{
...
#pragma HLS function_instantiate variable=dst_idx_0,src_idx_0,src_idx_1,src_idx_2
  ...
  unsigned long total_offset2 = ((0 * 200 + src_idx_0) * 44 + src_idx_1) * 5 + src_idx_2;
  merlinL2:
  for (i = 0; i < len / 4; ++i) {
