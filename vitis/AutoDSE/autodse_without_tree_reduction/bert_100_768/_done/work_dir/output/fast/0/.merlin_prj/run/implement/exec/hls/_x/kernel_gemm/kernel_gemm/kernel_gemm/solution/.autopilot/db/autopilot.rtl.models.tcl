set SynModuleInfo {
  ...
  {SRCNAME kernel_gemm MODELNAME kernel_gemm RTLNAME kernel_gemm IS_TOP 1
    SUBMODULES {
      {MODELNAME kernel_gemm_B_5_0_buf_RAM_AUTO_1R1W RTLNAME kernel_gemm_B_5_0_buf_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
