...
#pragma ACCEL debug fflush(stdout);
      if (C != 0) {
        memcpy((void *)(__m_C + 0 * 768),(const void *)C[0],100 * 768 * sizeof(float ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (B != 0) {
        memcpy((void *)(__m_B + 0 * 768),(const void *)B[0],100 * 768 * sizeof(float ));
      }
       else {
...
#pragma ACCEL debug fflush(stdout);
      if (C != 0) {
        memcpy((void *)C[0],(const void *)(__m_C + 0 * 768),100 * 768 * sizeof(float ));
      }
       else {
        printf("Error! Detected null pointer 'C' for external memory.\n");
        exit(1);
...
#pragma ACCEL debug fflush(stdout);
      if (B != 0) {
        memcpy((void *)B[0],(const void *)(__m_B + 0 * 768),100 * 768 * sizeof(float ));
      }
       else {
        printf("Error! Detected null pointer 'B' for external memory.\n");
        exit(1);
