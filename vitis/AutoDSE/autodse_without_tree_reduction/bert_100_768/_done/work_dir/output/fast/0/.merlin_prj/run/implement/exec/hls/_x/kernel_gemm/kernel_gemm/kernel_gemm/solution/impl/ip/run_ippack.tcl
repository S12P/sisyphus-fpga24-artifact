...
set Library     "hls"
set IPName      "kernel_gemm"
set Version     "1.0"
set DisplayName "Kernel_gemm"
set Revision    "2113521425"
...
set xo_kernel_name "kernel_gemm"
set xo_kernel_files {/home/spouget/iccad_24/autodse_without_tree_reduction/bert_100_768/_done/work_dir/output/fast/0/.merlin_prj/run/implement/exec/hls/__merlinkernel_kernel_gemm.c}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/spouget/iccad_24/autodse_without_tree_reduction/bert_100_768/_done/work_dir/output/fast/0/.merlin_prj/run/implement/exec/hls/_x/kernel_gemm/kernel_gemm/kernel_gemm/solution"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/spouget/iccad_24/autodse_without_tree_reduction/bert_100_768/_done/work_dir/output/fast/0/.merlin_prj/run/implement/exec/hls/_x/kernel_gemm/kernel_gemm/kernel_gemm/solution/.debug"
set xo_hls_files_dir "/home/spouget/iccad_24/autodse_without_tree_reduction/bert_100_768/_done/work_dir/output/fast/0/.merlin_prj/run/implement/exec/hls/_x/kernel_gemm/kernel_gemm/kernel_gemm/solution/impl/ip/hls_files"
set hdl_module_list {kernel_gemm_flow_control_loop_pipe_sequential_init
kernel_gemm_flow_control_loop_pipe_sequential_init
kernel_gemm_flow_control_loop_pipe_sequential_init
kernel_gemm_fadd_32ns_32ns_32_7_full_dsp_1
kernel_gemm_fmul_32ns_32ns_32_4_max_dsp_1
kernel_gemm_flow_control_loop_pipe_sequential_init
kernel_gemm_flow_control_loop_pipe_sequential_init
kernel_gemm_B_5_0_buf_RAM_AUTO_1R1W
kernel_gemm_A_5_0_buf_RAM_AUTO_1R1W
kernel_gemm_C_buf_RAM_AUTO_1R1W
kernel_gemm_merlin_gmem_kernel_gemm_512_C_m_axi
kernel_gemm_merlin_gmem_kernel_gemm_128_0_m_axi
kernel_gemm_merlin_gmem_kernel_gemm_512_0_m_axi
...
set kernel_xo "/home/spouget/iccad_24/autodse_without_tree_reduction/bert_100_768/_done/work_dir/output/fast/0/.merlin_prj/run/implement/exec/hls/_x/kernel_gemm/kernel_gemm/kernel_gemm/solution/impl/export.xo"
set detect_deadlock_json "kernel_gemm_message_dict.json"

## Variables
set Top "kernel_gemm"
set TopNoPrefix "kernel_gemm"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_merlin_gmem_kernel_gemm_512_C m_axi_merlin_gmem_kernel_gemm_128_0 m_axi_merlin_gmem_kernel_gemm_512_0"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_merlin_gmem_kernel_gemm_512_C {
        ...
        Object "merlin_gmem_kernel_gemm_512_C"
        ctype {
            AWLEN {
                Type "integer unsigned"
                Width "8"
        ...
        data_width "512"
        port_prefix "m_axi_merlin_gmem_kernel_gemm_512_C"
        param_prefix "C_M_AXI_MERLIN_GMEM_KERNEL_GEMM_512_C"
    ...
    m_axi_merlin_gmem_kernel_gemm_128_0 {
        ...
        Object "merlin_gmem_kernel_gemm_128_0"
        ctype {
            AWLEN {
                Type "integer unsigned"
                Width "8"
        ...
        data_width "512"
        port_prefix "m_axi_merlin_gmem_kernel_gemm_128_0"
        param_prefix "C_M_AXI_MERLIN_GMEM_KERNEL_GEMM_128_0"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 512 WSTRB 64 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 512 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_merlin_gmem_kernel_gemm_512_0 {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "merlin_gmem_kernel_gemm_512_0"
        ctype {
            AWLEN {
                Type "integer unsigned"
                Width "8"
        ...
        data_width "512"
        port_prefix "m_axi_merlin_gmem_kernel_gemm_512_0"
        param_prefix "C_M_AXI_MERLIN_GMEM_KERNEL_GEMM_512_0"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 512 WSTRB 64 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 512 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 20058 II x}
...
source -notrace "/mnt/software/xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
