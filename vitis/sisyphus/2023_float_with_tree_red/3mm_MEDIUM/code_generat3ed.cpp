...
void task1(float B[200][190], float E[180][190], float A[180][200], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int k;
    int j;
    int i;
...
#pragma HLS ARRAY_PARTITION variable=E cyclic factor=60 dim=1
#pragma HLS ARRAY_PARTITION variable=E cyclic factor=10 dim=2
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=190 dim=1
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=4 dim=2
#pragma HLS ARRAY_PARTITION variable=G cyclic factor=60 dim=1
...
#pragma HLS ARRAY_PARTITION variable=A cyclic factor=4 dim=2
    ...
    load_B(B, vB);
    load_A(A, vA);
    task1(B, E, A, vE, vA, vB, vF, vC, vD, vG);
    store_E(E, vE);
    load_F(F, vF);
