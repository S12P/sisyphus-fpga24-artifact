...
int main(){
    ...
    float val;
    float C_ori[3072][100];
    float C_new[3072][100];
    float A_ori[3072][3072];
    float A_new[3072][3072];
    float B_ori[3072][100];
    float B_new[3072][100];
    for(int i0 = 0; i0 < 3072; i0++){
    ...
    kernel_nlp((float4 *) C_new, (float16 *) A_new, (float4 *) B_new);
    for(int i0 = 0; i0 < 3072; i0++){
        for(int i1 = 0; i1 < 100; i1++){
