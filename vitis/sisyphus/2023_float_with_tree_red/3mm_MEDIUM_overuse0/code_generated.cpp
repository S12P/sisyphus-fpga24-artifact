...
void task3(float D[220][210], float C[190][220], float F[190][210], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int j;
    int i;
    int k;
    for (int j0 = 0; j0 < 3; j0++) {
...
void task5(float E[180][190], float F[190][210], float G[180][210], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int i;
    int j;
    int k;
    for (int i0 = 0; i0 < 2; i0++) {
...
#pragma HLS ARRAY_PARTITION variable=G cyclic factor=10 dim=2
    ...
    task3(D, C, F, vE, vA, vB, vF, vC, vD, vG);
    task4(G, vE, vA, vB, vF, vC, vD, vG);
    task5(E, F, G, vE, vA, vB, vF, vC, vD, vG);
    store_E(E, vE);
    store_F(F, vF);
    store_G(G, vG);
}
