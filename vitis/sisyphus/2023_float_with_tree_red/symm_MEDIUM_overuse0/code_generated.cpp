...
#pragma HLS ARRAY_PARTITION variable=temp2 cyclic factor=10 dim=1
#pragma HLS ARRAY_PARTITION variable=temp2 cyclic factor=80 dim=2
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=1 dim=1
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=80 dim=2
