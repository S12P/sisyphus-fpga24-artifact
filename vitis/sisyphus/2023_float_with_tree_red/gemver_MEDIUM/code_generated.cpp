...
void task0(float u1[400], float e2[400], float e1[400], float u2[400], float A[400][400], float alpha, float beta, float16 vA[10000], float16 vu1[25], float16 ve1[25], float16 vu2[25], float16 ve2[25], float16 vw[25], float16 vx[25], float16 vy[25], float16 vz[25]) {
    int i;
    int j;
...
void task1(float x[400], float A[400][400], float y[400], float alpha, float beta, float16 vA[10000], float16 vu1[25], float16 ve1[25], float16 vu2[25], float16 ve2[25], float16 vw[25], float16 vx[25], float16 vy[25], float16 vz[25]) {
    int j;
    int i;
    for (int j0 = 0; j0 < 1; j0++) {
        for (int i0 = 0; i0 < 1; i0++) {
...
void task2(float z[400], float x[400], float alpha, float beta, float16 vA[10000], float16 vu1[25], float16 ve1[25], float16 vu2[25], float16 ve2[25], float16 vw[25], float16 vx[25], float16 vy[25], float16 vz[25]) {
    int i;
    for (int i0 = 0; i0 < 1; i0++) {
...
void task3(float w[400], float x[400], float A[400][400], float alpha, float beta, float16 vA[10000], float16 vu1[25], float16 ve1[25], float16 vu2[25], float16 ve2[25], float16 vw[25], float16 vx[25], float16 vy[25], float16 vz[25]) {
    int i;
    int j;
                    float w_red[400];
    for (int i0 = 0; i0 < 1; i0++) {
...
#pragma HLS ARRAY_PARTITION variable=u1 cyclic factor=2 dim=1
...
#pragma HLS ARRAY_PARTITION variable=u2 cyclic factor=1 dim=1
...
#pragma HLS ARRAY_PARTITION variable=y cyclic factor=16 dim=1
    ...
    load_z(z, vz);
    load_w(w, vw);
    task0(u1, e2, e1, u2, A, alpha, beta, vA, vu1, ve1, vu2, ve2, vw, vx, vy, vz);
    task1(x, A, y, alpha, beta, vA, vu1, ve1, vu2, ve2, vw, vx, vy, vz);
    task2(z, x, alpha, beta, vA, vu1, ve1, vu2, ve2, vw, vx, vy, vz);
    task3(w, x, A, alpha, beta, vA, vu1, ve1, vu2, ve2, vw, vx, vy, vz);
    store_A(A, vA);
    store_x(x, vx);
    store_w(w, vw);
}
