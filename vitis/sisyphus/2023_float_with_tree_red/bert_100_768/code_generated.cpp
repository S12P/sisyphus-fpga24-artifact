...
void task1(float A[100][100], float C[100][768], float B[100][768], float16 vC[4800], float4 vA[2500], float16 vB[4800]) {
    int i;
    int j;
    int k;
    for (int i0 = 0; i0 < 5; i0++) {
...
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=20 dim=1
