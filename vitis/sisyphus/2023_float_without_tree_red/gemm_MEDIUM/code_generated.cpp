...
void task1(float C[200][220], float A[200][240], float B[240][220], float alpha, float beta, float4 vC[11000], float16 vA[3000], float4 vB[13200]) {
    int i;
    int j;
    int k;
    for (int i0 = 0; i0 < 1; i0++) {
        for (int j0 = 0; j0 < 1; j0++) {
            for (int k0 = 0; k0 < 60; k0++) {
...
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=200 dim=1
