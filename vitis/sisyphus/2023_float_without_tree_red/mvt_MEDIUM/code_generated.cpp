...
void task0(float x1[400], float A[400][400], float y_1[400], float16 vx1[25], float16 vx2[25], float16 vy_1[25], float16 vy_2[25], float16 vA[10000]) {
    int i;
    int j;
                    float x1_red[400];
...
void task1(float x2[400], float A[400][400], float y_2[400], float16 vx1[25], float16 vx2[25], float16 vy_1[25], float16 vy_2[25], float16 vA[10000]) {
    int j;
    int i;
    for (int j0 = 0; j0 < 1; j0++) {
        for (int i0 = 0; i0 < 1; i0++) {
...
#pragma HLS ARRAY_PARTITION variable=y_1 cyclic factor=400 dim=1
    ...
    load_x2(x2, vx2);
    load_y_2(y_2, vy_2);
    task0(x1, A, y_1, vx1, vx2, vy_1, vy_2, vA);
