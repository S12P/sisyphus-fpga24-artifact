...
void task0(float input[1][228][228], float weight[16][256][5][5], float output[16][224][224], float4 vinput[3326976], float1 vweight[1638400], float16 voutput[802816]) {
    int i;
    int j;
    int w;
    int h;
...
#pragma HLS ARRAY_PARTITION variable=input_S0 cyclic factor=1 dim=2
#pragma HLS ARRAY_PARTITION variable=input_S0 cyclic factor=80 dim=3
...
#pragma HLS ARRAY_PARTITION variable=output_S0 cyclic factor=1 dim=2
#pragma HLS ARRAY_PARTITION variable=output_S0 cyclic factor=16 dim=3

    task0(input_S0, weight_S0, output_S0, vinput, vweight, voutput);
}
