...
void task2(float tmp[390], float x[410], float A[390][410], float2 vA[79950], float2 vx[205], float2 vy[205], float2 vtmp[195]) {
    int i;
    int j;
    for (int i0 = 0; i0 < 1; i0++) {
        for (int j0 = 0; j0 < 1; j0++) {
...
void task3(float tmp[390], float y[410], float A[390][410], float2 vA[79950], float2 vx[205], float2 vy[205], float2 vtmp[195]) {
    int i;
    int j;
    for (int i0 = 0; i0 < 1; i0++) {
        for (int j0 = 0; j0 < 1; j0++) {
