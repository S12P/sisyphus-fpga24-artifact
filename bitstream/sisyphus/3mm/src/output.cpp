...
void load_G_S4 (float G[12][210], float2 vG[18900], int d0) {
#pragma HLS inline off
    for (int i0 = 0; i0 < 12; i0+=1){
        for (int i1 = 0; i1 < 210; i1+=2){
#pragma HLS pipeline II=1
            float2 tmp_G = vG[(i0 + d0 * 12) * 105 + i1/2];
            G[i0][i1 + 0] = tmp_G[0];
            G[i0][i1 + 1] = tmp_G[1];
        }
    }
}
void load_G_S5 (float G[90][210], float2 vG[18900], int d0) {
#pragma HLS inline off
    for (int i0 = 0; i0 < 90; i0+=1){
        for (int i1 = 0; i1 < 210; i1+=2){
#pragma HLS pipeline II=1
            float2 tmp_G = vG[(i0 + d0 * 90) * 105 + i1/2];
            G[i0][i1 + 0] = tmp_G[0];
            G[i0][i1 + 1] = tmp_G[1];
        }
    }
...
void store_G_S4 (float G[12][210], float2 vG[18900], int d0) {
#pragma HLS inline off
    for (int i0 = 0; i0 < 12; i0+=1){
        for (int i1 = 0; i1 < 210; i1+=2){
#pragma HLS pipeline II=1
            ...
            tmp_G[0] = G[i0][i1 + 0];
            tmp_G[1] = G[i0][i1 + 1];
            vG[(i0 + d0 * 12) * 105 + i1/2] = tmp_G;
        }
    }
}
void store_G_S5 (float G[90][210], float2 vG[18900], int d0) {
#pragma HLS inline off
    for (int i0 = 0; i0 < 90; i0+=1){
        for (int i1 = 0; i1 < 210; i1+=2){
#pragma HLS pipeline II=1
...
void task1(float E[180][190], float A[180][200], float B[200][190], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int i;
    int j;
    int k;
    for (int i0 = 0; i0 < 15; i0++) {
...
void task3(float F[190][210], float D[220][210], float C[190][220], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int i;
    int j;
    int k;
...
void task4(float G[12][210], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int i;
    int j;
    for (int i0 = 0; i0 < 15; i0++) {
        load_G_S4(G, vG, i0);
...
void task5(float F[190][210], float E[180][190], float G[90][210], float2 vE[17100], float8 vA[4500], float2 vB[19000], float2 vF[19950], float4 vC[10450], float2 vD[23100], float2 vG[18900]) {
    int i;
    int j;
    int k;
...
#pragma HLS ARRAY_PARTITION variable=F cyclic factor=1 dim=1
#pragma HLS ARRAY_PARTITION variable=F cyclic factor=70 dim=2
#pragma HLS ARRAY_PARTITION variable=E cyclic factor=12 dim=1
...
#pragma HLS ARRAY_PARTITION variable=D cyclic factor=11 dim=1
#pragma HLS ARRAY_PARTITION variable=D cyclic factor=10 dim=2
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=1 dim=1
#pragma HLS ARRAY_PARTITION variable=C cyclic factor=44 dim=2
#pragma HLS ARRAY_PARTITION variable=G_S4 cyclic factor=1 dim=1
#pragma HLS ARRAY_PARTITION variable=G_S5 cyclic factor=1 dim=1
#pragma HLS ARRAY_PARTITION variable=G_S4 cyclic factor=70 dim=2
#pragma HLS ARRAY_PARTITION variable=G_S5 cyclic factor=70 dim=2
