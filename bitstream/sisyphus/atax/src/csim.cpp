...
int main() {
  ...
  float A_ori[390][410];
  float A_new_before_trans_0[392 * 416];
  float A_new_0[392 * 416];
  float A_new_before_trans_1[392 * 416];
  float A_new_1[392 * 416];
  float x_ori[410];
  ...
  float y_new_0[416];
  float tmp_ori[390];
  float tmp_new_before_trans_0[392];
  float tmp_new_0[392];
  int memIndex = 0;
  float val;
  ...
  // //   for (int d1_0 = 0; d1_0 < 104; d1_0++) {
  //     for (int d0_1 = 0; d0_1 < 392; d0_1++) {
  //       for (int d1_1 = 0; d1_1 < 416; d1_1++) {
  //         int d0 =  d0_1;
  //         int d1 = d1_0 * 4 + d1_1;
  //         A_new_0[memIndex] = A_new_before_trans_0[d0 * 416 + d1 * 1];
  //         memIndex++;
  //       }
  //     }
  // //   }
