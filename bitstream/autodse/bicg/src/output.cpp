...
#pragma HLS INTERFACE m_axi port=A offset=slave depth=79950 bundle=merlin_gmem_kernel_nlp_64_0
  
#pragma HLS INTERFACE m_axi port=p offset=slave depth=195 bundle=merlin_gmem_kernel_nlp_64_1
  
#pragma HLS INTERFACE m_axi port=q offset=slave depth=26 bundle=merlin_gmem_kernel_nlp_512_q
  
#pragma HLS INTERFACE m_axi port=r offset=slave depth=26 bundle=merlin_gmem_kernel_nlp_512_0
  
#pragma HLS INTERFACE m_axi port=s offset=slave depth=25 bundle=merlin_gmem_kernel_nlp_512_s
