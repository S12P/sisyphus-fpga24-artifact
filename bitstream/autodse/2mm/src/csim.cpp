...
int main(){
    ...
    for(int i0 = 0; i0 < 180; i0++){
        for(int i1 = 0; i1 < 190; i1++){
            if(abs(tmp_ori[i0][i1] - tmp_new[i0][i1])/tmp_ori[i0][i1] > 0.01){
    ...
    for(int i0 = 0; i0 < 210; i0++){
        for(int i1 = 0; i1 < 190; i1++){
            if(abs(B_ori[i0][i1] - B_new[i0][i1])/B_ori[i0][i1] > 0.01){
    ...
    for(int i0 = 0; i0 < 190; i0++){
        for(int i1 = 0; i1 < 220; i1++){
            if(abs(C_ori[i0][i1] - C_new[i0][i1])/C_ori[i0][i1] > 0.01){
    ...
    for(int i0 = 0; i0 < 180; i0++){
        for(int i1 = 0; i1 < 220; i1++){
            if(abs(D_ori[i0][i1] - D_new[i0][i1])/D_ori[i0][i1] > 0.01){
                printf("Error in D[%d][%d]... %f %f\n", i0, i1, D_ori[i0][i1], D_new[i0][i1]);
                return 1;
            }
        }
    }
